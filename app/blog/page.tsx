...
const posts = [
  ...
  { slug: "delete-pdf-pages", color: "from-red-500 to-rose-400", image: "/pdf.png", tool: "/tools/delete-pages",
    EN: { title: "Delete Pages from PDF — Remove Unwanted Pages Easily", excerpt: "Select and remove specific pages from your PDF. Preview each page before deletion with zoom support.", date: "Mar 15, 2026", category: "Tutorial", readTime: "3 min" },
    RO: { title: "Sterge Pagini din PDF — Elimina Paginile Nedorite Usor", excerpt: "Selecteaza si elimina pagini specifice din PDF. Previzualizeaza fiecare pagina inainte de stergere cu zoom.", date: "15 Mar 2026", category: "Tutorial", readTime: "3 min" } },
  { slug: "encrypt-decrypt-pdf", color: "from-orange-500 to-red-400", image: "/pdf.png", tool: "/tools/encrypt-pdf",
    EN: { title: "How to Encrypt and Decrypt PDF Files Securely", excerpt: "Protect sensitive PDFs with AES-256 encryption. Learn about password recovery and how encrypted files work.", date: "Mar 14, 2026", category: "Security", readTime: "5 min" },
    RO: { title: "Cum sa Criptezi si Decriptezi Fisiere PDF in Siguranta", excerpt: "Protejeaza PDF-urile sensibile cu criptare AES-256. Afla despre recuperarea parolei si cum functioneaza fisierele criptate.", date: "14 Mar 2026", category: "Securitate", readTime: "5 min" } },
  { slug: "merge-pdf-select-pages", color: "from-blue-500 to-indigo-400", image: "/pdf.png", tool: "/tools/merge-pdf",
    EN: { title: "Merge PDFs with Page-Level Selection", excerpt: "Combine multiple PDFs and choose exactly which pages to include. Drag to reorder files and zoom into page previews.", date: "Mar 13, 2026", category: "Tutorial", readTime: "4 min" },
    RO: { title: "Unifica PDF-uri cu Selectie la Nivel de Pagina", excerpt: "Combina mai multe PDF-uri si alege exact ce pagini sa incluzi. Trage pentru a reordona fisierele si mareste previzualizarile.", date: "13 Mar 2026", category: "Tutorial", readTime: "4 min" } },
  { slug: "multi-image-to-pdf", color: "from-purple-500 to-violet-400", image: "/img.png", tool: "/convert/image-to-pdf",
    EN: { title: "Convert Multiple Images to PDF — Drag, Reorder & Combine", excerpt: "Select multiple JPG or PNG images, drag to reorder, and create a single PDF. Perfect for photo albums and presentations.", date: "Mar 12, 2026", category: "Tutorial", readTime: "3 min" },
    RO: { title: "Converteste Mai Multe Imagini in PDF — Trage, Reordoneaza si Combina", excerpt: "Selecteaza mai multe imagini JPG sau PNG, trage pentru a reordona, si creaza un singur PDF. Perfect pentru albume foto.", date: "12 Mar 2026", category: "Tutorial", readTime: "3 min" } },
  { slug: "pin-favorite-tools", color: "from-amber-500 to-orange-400", image: "/edit.png", tool: null,
    EN: { title: "Pin Your Favorite Tools for Quick Access", excerpt: "Use the new Pin system to save your most-used tools. Pinned items appear at the top of the sidebar for instant navigation.", date: "Mar 11, 2026", category: "News", readTime: "2 min" },
    RO: { title: "Fixeaza Instrumentele Preferate pentru Acces Rapid", excerpt: "Foloseste noul sistem de Pin pentru a salva instrumentele cele mai utilizate. Elementele fixate apar in partea de sus a barei laterale.", date: "11 Mar 2026", category: "Noutati", readTime: "2 min" } },
  { slug: "view-documents-online", color: "from-cyan-500 to-teal-400", image: "/word.png", tool: "/tools/word-viewer",
    EN: { title: "View Word, Excel, PPTX and Images Online — No Software", excerpt: "Open and view documents directly in your browser. Supports PDF, Word, Excel, PowerPoint, JPG and PNG files.", date: "Mar 10, 2026", category: "Guide", readTime: "3 min" },
    RO: { title: "Vizualizeaza Word, Excel, PPTX si Imagini Online — Fara Software", excerpt: "Deschide si vizualizeaza documente direct in browser. Suporta PDF, Word, Excel, PowerPoint, JPG si PNG.", date: "10 Mar 2026", category: "Ghid", readTime: "3 min" } },
]
