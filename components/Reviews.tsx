...
<button onClick={toggleMute} title={muteLive ? 'Unmute notifications' : 'Mute notifications'} className={`ml-2 w-7 h-7 rounded-lg flex items-center justify-center transition ${classicMode ? "bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600" : "bg-white/5 text-white/30 hover:bg-white/10 hover:text-white/60"}`}>
{muteLive
